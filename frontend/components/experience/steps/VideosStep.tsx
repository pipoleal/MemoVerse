...
export default function VideosStep() {
  const { videoEntries, setVideoEntries, ensureDraftId } = useExperience();
  ...
  function handleFiles(event: ChangeEvent<HTMLInputElement>) {
    ...
    const availableSlots = MAX_VIDEOS - videoEntries.length;
    ...
    const newEntries: MediaEntry[] = videoFiles.map((file) => {
      const validationError = validateFileForUpload("video", file);
        ...
        <div className="mt-3 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-5 max-w-2xl text-slate-300">
              Alguns momentos merecem ser vistos novamente.
              Adicione os vídeos que fazem parte dessa história.
            </p>
          </div>
        ...
        <div className="mt-12">
          ...
          >
            ...
            <p className="mt-3 max-w-md text-slate-400">
              {limitReached
                ? "Você já adicionou os 3 vídeos permitidos nesta experiência."
                : "Escolha até 3 vídeos para fazer parte dessa história."}
            </p>
