...
// Textura procedural da estrela (halo + raios + núcleo, singleton) agora
// vive em lib/starTexture.ts — compartilhada com GalaxyTransition.tsx
// (Galáxia Viva da experiência pública), que passou a usar a mesma
// linguagem visual. Nada do desenho em si mudou.
